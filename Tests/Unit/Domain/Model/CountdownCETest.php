...
/**
 * Test case for class Tx_JheCountdownce_Domain_Model_CountdownCE.
 *
 * @version $Id$
 ...
 */
class Tx_JheCountdownce_Domain_Model_CountdownCETest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
